public class Main {
    public static void main(String[] args) {
        ...
        //Вывод результатов:
        System.out.print(employees[0].toString()); //Выводит результат в конкретном элементе массива в toString.
        Employee.getAList(employees);//Выводит результат всего массива в toString.
